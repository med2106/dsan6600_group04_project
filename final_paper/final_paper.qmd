...
::: {.table tbl-cap="EfficientNet Model Comparison" #tbl-1}
...
{{< pagebreak >}} <!--remove if not needed here-->
**Iterative Process:**
...
{{< pagebreak >}}
::: {.table tbl-cap="EfficientNetB7 Classification Report" #tbl-2}
...
![EfficientNetB7 Confusion Matrix](plots/b7_confusion_matrix.png){width="68%" height="auto"}

{{< pagebreak >}}
## EfficientNetV2-M Model

::: {.table tbl-cap="EfficientNetV2-M Classification Report" #tbl-3}
| Hair Type    | Precision | Recall | **F1-Score** | Support |
|--------------|-----------|--------|----------|---------|
...
![EfficientNetV2-M Confusion Matrix](plots/v2m_confusion_matrix.png){width="68%" height="auto"}
...
![EfficientNetV2-M Training Progression](plots/v2m_training.png){width="80%" height="auto"}

### Computational Analysis

::: {.table tbl-cap="EfficientNetV2-M fine-tuned model performance" #tbl-4}
| Metric | Value |
|--------|-------|
| Model size | ~52.9M parameters, ~208 MB |
| Training Memory usage | ~8.5 GB (Tesla T4 GPU) |
| Training speed (per epoch) | ~550 sec. |
| Inference speed (per image) | 20-30ms; <1 sec. on [Hugging Face](https://huggingface.co/spaces/med2106/hairNet) app |
:::

#### Model Size {.unnumbered}
...
The entirety of our code can be found on [Github](https://github.com/med2106/dsan6600_group04_project)

#### Appendix 2: Web Application {.unnumbered}
...
>> Application Link: [https://huggingface.co/spaces/med2106/hairNet](https://huggingface.co/spaces/med2106/hairNet)
